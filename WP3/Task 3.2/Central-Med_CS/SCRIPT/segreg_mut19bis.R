...
case="Red mullet 19"
var=read.csv('MUT19_10-200_Q3.csv',sep=';',header=TRUE)
...
# legend_lty<-c(legend_lty,3)
  ...
  legend("topright",legend=legend_names,col=legend_color,lwd=c(2,2),lty=legend_lty,cex=1)
