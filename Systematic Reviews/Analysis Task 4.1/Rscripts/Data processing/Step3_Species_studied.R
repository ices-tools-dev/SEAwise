...
#
#     By Karin van der Reijden, small adjustions by Esther D. Beukhof
#     April 2022
#
#####################################################################################################################-
#####################################################################################################################-
...
# Depends on whether full or cropped dataset should be used
if(dataset == "cropped"){
...
#-----------------------------------------------#
# Run remaining part of script depending on dataset
#
#  info: they are the same for each dataset, except that for the full dataset, objects are not saved while running
#-----------------------------------------------#
