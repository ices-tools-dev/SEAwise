...
grepl("rindorf",tolower(paste0(dbraw$Authors,collapse="%%"))) # TRUE, Rindorf is an author in the list
grepl("sguotti",tolower(paste0(dbraw$Authors,collapse="%%"))) # FALSE, Sguotti is not an author in the list
